...
var _ = Describe("buildPlaylist", func() {
	...
	BeforeEach(func() {
		...
		router = New(ds, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
var _ = Describe("UpdatePlaylist", func() {
	...
	BeforeEach(func() {
		...
		router = New(ds, nil, nil, nil, nil, nil, nil, nil, playlists, nil, nil, nil, nil, nil, nil, nil, nil, nil)
	})
