...
type MediaFile struct {
	...
	UserTags []string `structs:"-" json:"userTags,omitempty" hash:"ignore"` // AI-written tags (model.MediaFileTag, source=ai) - displayed as "AI Tags"
	MyTags   []string `structs:"-" json:"myTags,omitempty" hash:"ignore"`   // The requesting user's own hand-added tags (model.MediaFileTag, source=user) - displayed as "My Tags"
