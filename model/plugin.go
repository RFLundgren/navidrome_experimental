...
type Plugin struct {
	...
	// ManifestSchemaVersion records which build's understanding of the
	// Manifest struct was used to populate the Manifest field above - see
	// plugins.CurrentManifestSchemaVersion for why this exists separately
	// from SHA256.
	ManifestSchemaVersion int       `structs:"manifest_schema_version" json:"manifestSchemaVersion"`
